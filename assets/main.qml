    ...
    Page {
        Container {
            ...
            ListView { // This is the 'view' part of the model-view-controller
                dataModel: poke_list // Connect 'pokemon_list' as the 'model' for this view
